...
if __name__ == '__main__':
    ...
    with alive_bar(100 * 50 * 5) as bar:
        ...
        for number_of_agent in [2,3,4,5,6]:
            ...
            titel_list = ['map_name', 'start_state', 'time', 'minimize', 'mwrp_cost', 'final_cost', 'didet_see',
                          'repet_benxmark', 'seed']
            ...
            for sp in start_pos:
                for repet in range(50):
                    ...
                    loger.write([map_type, sp, time.time() - time1, minimize, old_cost, new_cost, dident_see, repet,
                                 random_seed[repet]])
